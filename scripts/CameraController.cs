...
namespace Trinketos.HaciendaSimulator
{
    public partial class CameraController : Node3D
    {
        ...
        public override void _Process(double delta)
        {
            ...
            // Mierda larga solo para no escribir lineas y lineas de codigo para esta mamada.
            GlobalPosition = GlobalPosition with {X = Mathf.Clamp(GlobalPosition.X,_bounds.Position.X,_bounds.End.X), Z = Mathf.Clamp(GlobalPosition.Z,_bounds.Position.Z,_bounds.End.Z)};
